 ...
 * @subpackage Rand
 */
abstract class Zend2to1_Math_Rand
{
    /**
    ...
    public static function getBytes($length, $strong = false)
    {
        ...
        if ($strong) {
            throw new Zend2to1_Math_Exception_RuntimeException(
    ...
    {
        if ($min > $max) {
            throw new Zend2to1_Math_Exception_DomainException(
    ...
    {
        if ($length < 1) {
            throw new Zend2to1_Math_Exception_DomainException('Length should be >= 1');
        }
