 ...
 * @package    Zend_Stdlib
 */
abstract class Zend_Stdlib_ArrayUtils implements Traversable
{
    /**
    ...
    public static function iteratorToArray($iterator, $recursive = true)
    {
        if (!is_array($iterator) && !$iterator instanceof Traversable) {
            throw new Zend2to1_Stdlib_Exception_InvalidArgumentException(__METHOD__ . ' expects an array or Traversable object');
        }
